...
func (tq *TrainingQuery) IDs(ctx context.Context) (ids []int, err error) {
...
//		GroupBy(training.FieldCreatedAt).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
...
//
//	client.Training.Query().
//		Select(training.FieldCreatedAt).
//		Scan(ctx, &v)
...
func (tq *TrainingQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(training.Table, training.Columns, sqlgraph.NewFieldSpec(training.FieldID, field.TypeInt))
	_spec.From = tq.sql
